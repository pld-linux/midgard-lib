...
Midgard jest wolnodostępną platformą do tworzenia i publikowania
aplikacji WWW, bazującą na języku skryptowym PHP. Midgard jest
narzędziem do tworzenia, modyfikacji i prowadzenia serwisów opartych
...
Pliki nagłówkowe i inne do tworzenia aplikacji z użyciem midgard-lib.
